...
class PermissionTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permissionArray[] = ['name' => 'view_department', 'display_name' => '查看部门', 'description' => '查看部门',];
        $permissionArray[] = ['name' => 'create_department', 'display_name' => '创建部门', 'description' => '创建部门',];
        $permissionArray[] = ['name' => 'edit_department', 'display_name' => '编辑部门', 'description' => '编辑部门',];
        $permissionArray[] = ['name' => 'delete_department', 'display_name' => '删除部门', 'description' => '删除部门',];
        $permissionArray[] = ['name' => 'view_log', 'display_name' => '查看日志', 'description' => '查看日志',];
        $permissionArray[] = ['name' => 'delete_log', 'display_name' => '删除日志', 'description' => '删除日志',];
        $permissionArray[] = ['name' => 'view_u_disk', 'display_name' => '查看U盾', 'description' => '查看U盾',];
        $permissionArray[] = ['name' => 'create_u_disk', 'display_name' => '创建U盾', 'description' => '创建U盾',];
        $permissionArray[] = ['name' => 'edit_u_disk', 'display_name' => '编辑U盾', 'description' => '编辑U盾',];
        $permissionArray[] = ['name' => 'delete_u_disk', 'display_name' => '删除U盾', 'description' => '删除U盾',];
        $permissionArray[] = ['name' => 'view_ip', 'display_name' => '查看IP', 'description' => '查看IP',];
        $permissionArray[] = ['name' => 'create_ip', 'display_name' => '创建IP', 'description' => '创建IP',];
        $permissionArray[] = ['name' => 'edit_ip', 'display_name' => '编辑IP', 'description' => '编辑IP',];
        $permissionArray[] = ['name' => 'delete_ip', 'display_name' => '删除IP', 'description' => '删除IP',];
